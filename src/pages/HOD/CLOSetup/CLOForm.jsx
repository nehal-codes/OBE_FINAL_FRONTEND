...
const CLOForm = () => {
  ...
  const bloomLevels = [
    { value: "REMEMBER", label: "Remember", color: "bg-blue-50 text-blue-700 border-blue-200" },
    { value: "UNDERSTAND", label: "Understand", color: "bg-green-50 text-green-700 border-green-200" },
    { value: "APPLY", label: "Apply", color: "bg-yellow-50 text-yellow-700 border-yellow-200" },
    { value: "ANALYZE", label: "Analyze", color: "bg-orange-50 text-orange-700 border-orange-200" },
    { value: "EVALUATE", label: "Evaluate", color: "bg-purple-50 text-purple-700 border-purple-200" },
    { value: "CREATE", label: "Create", color: "bg-pink-50 text-pink-700 border-pink-200" },
  ];
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h1 className="text-2xl font-bold text-gray-900">
                      {isEdit ? "Edit Course Learning Outcome" : "Create Course Learning Outcomes"}
                    </h1>
                ...
                <div className="bg-white rounded-xl border border-gray-200 p-4 inline-block">
                  <div className="flex flex-wrap items-center gap-4">
                    <div className="flex items-center gap-2 bg-gray-50 px-3 py-2 rounded-lg">
                      ...
                      <span className="font-medium text-gray-900">{course?.name || courseDraft?.name || "Draft Course"}</span>
                    </div>
                    <div className="flex items-center gap-2 bg-blue-50 px-3 py-2 rounded-lg">
                      <FiHash className="w-4 h-4 text-blue-600" />
                      <span className="font-mono font-semibold text-blue-700">{course?.code || courseDraft?.code || "---"}</span>
                    </div>
                    {course?.credits && (
                      <div className="flex items-center gap-2 bg-emerald-50 px-3 py-2 rounded-lg">
                        <FiCreditCard className="w-4 h-4 text-emerald-600" />
                        <span className="font-medium text-emerald-700">{course.credits} Credits</span>
                      </div>
                    )}
                    {course?.semester && (
                      <div className="flex items-center gap-2 bg-purple-50 px-3 py-2 rounded-lg">
                        <FiCalendar className="w-4 h-4 text-purple-600" />
                        <span className="font-medium text-purple-700">Semester {course.semester}</span>
                      </div>
                    )}
                  </div>
                </div>
              ...
              {!isEdit && (
                <div className="flex items-center gap-2 bg-white border border-gray-200 rounded-xl px-4 py-3">
                  ...
                  <div>
                    ...
                    <div className="font-bold text-gray-900 text-lg">{count} CLO{count !== 1 ? 's' : ''}</div>
                  </div>
                </div>
              )}
            </div>
          ...
          <div className="lg:col-span-1">
            <div className="bg-white rounded-2xl border border-gray-200 shadow-sm p-5 sticky top-8">
              <div className="flex items-center justify-between mb-5">
                <div>
                  <h2 className="font-semibold text-gray-900 text-lg">CLO List</h2>
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div className="text-left">
                        <div className={`font-semibold text-base ${
                          activeIndex === index ? 'text-blue-800' : 'text-gray-900'
                        }`}>
                          {clo.cloCode}
                        </div>
              ...
              <div className="bg-white rounded-2xl border border-gray-200 shadow-sm p-6">
                ...
                <div className="flex items-center justify-between mb-8 pb-6 border-b border-gray-200">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <h2 className="font-bold text-gray-900 text-xl">Define Learning Outcome</h2>
                    </div>
                  </div>
                ...
                <div className="mb-8">
                  ...
                  <div className="relative">
                    ...
                    <div className="mt-2 text-sm text-gray-500">
                      What should students be able to do? Use clear, measurable action verbs...
                    </div>
                  </div>
                </div>
                ...
                <div className="mb-8">
                  ...
                  <div className="grid grid-cols-2 lg:grid-cols-3 gap-3">
                    {bloomLevels.map((level) => (
                      ...
                      >
                        <div className="font-semibold text-gray-900 text-base mb-1">{level.label}</div>
                ...
                <div className="mb-8">
                  ...
                  <div className="space-y-4">
                    <div className="text-center bg-gradient-to-r from-gray-50 to-white p-6 rounded-2xl border border-gray-200">
                      ...
                      <div className="text-gray-600">Minimum score required</div>
                    </div>
                    <input
                      type="range"
                      min="40"
                    ...
                    <p className="text-gray-600 text-sm bg-blue-50 p-3 rounded-lg border border-blue-100">
                      ...
                      This is the minimum score students must achieve to be considered as attaining this learning outcome.
                    </p>
                  </div>
                </div>
              </div>
                ...
                <div className="flex gap-3">
                  ...
                  {!isEdit && (
                    <button
                      ...
                      className="px-6 py-3 border border-gray-300 text-gray-700 rounded-xl hover:bg-gray-50 transition-all font-medium text-base hover:shadow-sm flex items-center gap-2"
                    >
          ...
          <div className="mt-8 grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div className="bg-gradient-to-r from-white to-gray-50 rounded-xl p-5 border border-gray-200 shadow-sm">
              <div className="flex items-center gap-3 mb-3">
                ...
                <div>
                  <div className="text-sm text-gray-600">Bloom Levels Used</div>
